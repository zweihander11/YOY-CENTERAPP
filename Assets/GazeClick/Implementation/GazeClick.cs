...
public class GazeClick : MonoBehaviour, IGvrPointer{ 
	...
	void Update () {
		...
		case LoockingState.normal:
			HandleNormalState ();
			break;
		case LoockingState.spinning:            //Caso: is active when the reticle view at object                
                HandleSpinningState ();
			break;
	...
	private void HandleSpinningState(){     //Se debe capturar el objeto para mover la reticula a su centro
